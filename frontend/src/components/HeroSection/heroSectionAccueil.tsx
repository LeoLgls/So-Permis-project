/**
 * Composant : HeroSectionAccueil
 * 
 * Ce composant React représente une section héroïque spécifique à la page d'accueil. Il affiche une image de fond,
 * des forfaits sous forme de cartes, et une transition de couleur en fonction d'une propriété. Le composant utilise
 * styled-components pour le style et intègre une fonctionnalité de transition dynamique de la hauteur de l'image en fonction
 * de la hauteur des cartes affichées.
 * 
 * Styles :
 ...
 * - CardContainer : Un conteneur de cartes stylisé utilisant une disposition de grille pour s'adapter automatiquement à
 *                   la taille de l'écran avec un espacement entre les cartes.
 * - Transition : Une transition de couleur en fonction d'une propriété, utilisée comme fond pour créer un effet de
 *                transition en dégradé.
 ...
 * 
 * État :
 * - heroImgHeight : Une variable d'état pour stocker dynamiquement la hauteur de l'image héroïque en fonction de la
 *                   hauteur des cartes affichées.
 * 
 * Effets :
